...
var wobbleSpeed = 11, wobbleDist = 0.5;

Coin.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  var wobblePos2 = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(wobblePos, wobblePos2));
};

var maxStep = 0.5;

var wobbleSpeed = 2, wobbleDist = 0.4;
